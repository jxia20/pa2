...
public class SpawnTest extends UniversalActor  {
	public static void main(String args[]) {
		...
		SpawnTest instance = (SpawnTest)new SpawnTest(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SpawnTest(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SpawnTest.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SpawnTest(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SpawnTest.getReferenceByLocation(new UAL(ual)); }
	public SpawnTest(boolean o, UAN __uan)	{ super(false,__uan); }
	public SpawnTest(boolean o, UAL __ual)	{ super(false,__ual); }
	public SpawnTest(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public SpawnTest(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public SpawnTest(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public SpawnTest()		{  }
	public SpawnTest(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "pa2.SpawnTest", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public SpawnTest self;
		public void updateSelf(ActorReference actorReference) {
			((SpawnTest)actorReference).setUAL(getUAL());
			((SpawnTest)actorReference).setUAN(getUAN());
			self = new SpawnTest(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "pa2.SpawnTest$State" );
		...
		public void act(String[] args) {
			...
			salsa.naming.UAL ual = new salsa.naming.UAL("rmsp://127.0.0.1:51001/UAL/test-"+t);
			salsa.naming.UAN uan = new salsa.naming.UAN("uan://127.0.0.1:5050/test-"+t);
			RemoteEcho r = ((RemoteEcho)new RemoteEcho(uan, ual,this).construct());
			{
				// r<-hello("world")
				{
					Object _arguments[] = { "world" };
					Message message = new Message( self, r, "hello", _arguments, null, null );
